  ...
  return (
    <svg width="20" height="36" viewBox="0 0 20 36" fill="none" xmlns="http://www.w3.org/2000/svg">
      <path
        ...
        stroke={pathname === '/notification' ? pallete.primary[2] : pallete.gray[4]}
        strokeWidth="2"
        strokeLinecap="round"
      ...
      <path
        ...
        fill={pathname === '/notification' ? pallete.primary[2] : pallete.gray[4]}
      />
      <path
        d="M9.5 1V2.90476"
        stroke={pathname === '/notification' ? pallete.primary[2] : pallete.gray[4]}
      ...
      <path
        ...
        fill={pathname === '/notification' ? pallete.primary[2] : pallete.gray[3]}
      />
    </svg>
  );
};
